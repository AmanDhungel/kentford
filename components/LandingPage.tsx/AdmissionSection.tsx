...
const admissionSteps = [
  ...
  {
    step: 4,
    text: "Fusion College will issue with a letter of offer/student agreement.",
    side: "left",
    color: "bg-[#D97706]",
  },
  {
    step: 5,
    text: "Read carefully and Sign the Letter of Offer/student agreement and return to Fusion College.",
    side: "right",
    color: "bg-[#00A9A5]",
  },
  {
    step: 6,
    text: "Make Payment by bank Transfer and Send a copy of your Payment receipt to Fusion college.",
    side: "right",
    color: "bg-[#D97706]",
  },
  {
    step: 7,
    text: "Fusion College will issue your Confirmation of Enrollment (COE). You are now ready to apply for your student visa.",
    side: "right",
    color: "bg-[#00A9A5]",
  },
  {
