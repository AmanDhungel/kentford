        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="flex-1 space-y-8">
            <div className="space-y-4">
              <Badge className="bg-[#008080] hover:bg-[#006666] rounded-none px-4 py-1">
                Hospitality
              </Badge>
            ...
            <Tabs defaultValue="entry" className="w-full">
              <TabsList className="grid grid-cols-3 w-full md:grid-cols-3 h-auto bg-[#008080] p-2 rounded-none min-h-fit gap-2  mb-1">
                <TabsTrigger
                  value="entry"
                ...
                <TabsTrigger
                  value="units"
                  className="data-[state=active]:bg-gray-200 bg-white min-h-fit p-2  data-[state=active]:text-[#008080] text-black text-xs py-4 gap-2 rounded-none">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="p-3 bg-slate-50 border-l-4 border-[#008080]">
                          <p className="text-sm">
        ...
        <section className="bg-white border border-slate-100 shadow-sm p-8 md:p-12">
          <div className="flex flex-col md:flex-row gap-12">
            <div className="md:w-1/3">
              <HeartHandshake className="text-[#008080] mb-4" size={48} />
